...
|Number of Points $\sim$ accuracy (max error)|FFT|FIR|ASY|AAA|LogLog|LogAsy|LsqAsy|
|---|---|---|---|---|---|---|---|
...
|Type4: Rational (order number > 1) + Schwartz|$10^6\sim10^{-4.5}$ | $10^6\sim10^{-4.5}$ |$10^{4.5}\sim10^{-15}$ |$10^{5.5}\sim10^{-11}$ |
|Type5: Log-Rational |$10^6\sim10^{-5.5}$ | $10^6\sim10^{-5.5}$ |$10^{6.5}\sim10^{-9.5}$ |$10^{5.7}\sim10^{-6}$|
|Type6: Log-Rational + Rational (order number > 1) + Schwartz|$10^6\sim10^{-4.5}$ | $10^6\sim10^{-4.5}$ |$10^{6.5}\sim10^{-9.5}$ |$10^{5.7}\sim10^{-6}$ |
...
|Type10: sum of d-Rational||$10^{6.3}\sim10^{-4.5}$|$10^{6.3}\sim10^{-6}$||$10^{-6.3}\sim10^{-7.5}$|$10^{6.3}\sim10^{-9}$|$10^{6.3}\sim10^{-9}$|
